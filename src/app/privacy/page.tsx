  ...
  return (
    <Container maxWidth="md" sx={{ py: 6 }}>
      ...
      <Box sx={{ color: "text.secondary", lineHeight: 1.8 }}>
        ...
        <Typography variant="h3" sx={{ fontSize: 18, color: "text.primary", mt: 2 }}>Data controller</Typography>
        <Typography sx={{ display: "block", mb: 1 }}>
        ...
        <Typography variant="h3" sx={{ fontSize: 18, color: "text.primary", mt: 2 }}>Legal basis (GDPR Art. 6)</Typography>
        <Typography sx={{ display: "block", mb: 1 }}>
        ...
        <Typography variant="h3" sx={{ fontSize: 18, color: "text.primary", mt: 2 }}>Retention</Typography>
        <Typography sx={{ display: "block", mb: 1 }}>
        ...
        <Typography variant="h3" sx={{ fontSize: 18, color: "text.primary", mt: 2 }}>International transfers</Typography>
        <Typography sx={{ display: "block", mb: 1 }}>
        ...
        <Typography variant="h3" sx={{ fontSize: 18, color: "text.primary", mt: 2 }}>Your rights</Typography>
        <Typography sx={{ display: "block", mb: 1 }}>
        ...
        <Typography variant="h3" sx={{ fontSize: 18, color: "text.primary", mt: 2 }}>Cookies</Typography>
        <Typography sx={{ display: "block", mb: 1 }}>
        ...
        <Typography variant="h3" sx={{ fontSize: 18, color: "text.primary", mt: 2 }}>Consent management (CMP)</Typography>
        <Typography sx={{ display: "block", mb: 1 }}>
