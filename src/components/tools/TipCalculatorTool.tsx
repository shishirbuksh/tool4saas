  ...
  return (
    <ToolPaper>
        ...
        <Box>
          ...
          <Slider
            value={tip}
            onChange={(_, v) => setTip(v as number)}
            min={0}
            max={30}
            step={1}
        ...
        <Stack spacing={1.5} sx={{ mt: 1 }}>
          <Box sx={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <Typography sx={{ fontWeight: 700 }}>{money(tipAmount)}</Typography>
          </Box>
          <Box sx={{ display: "flex", justifyContent: "space-between" }}>
          ...
          >
            ...
            <Typography sx={{ fontWeight: 800, color: "primary.main" }}>{money(perPerson)}</Typography>
           </Box>
         </Stack>
    </ToolPaper>
  );
