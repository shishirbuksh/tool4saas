  ...
  return (
    <Box>
      <Stack direction="row"   sx={{ alignItems: "center", justifyContent: "space-between",  mb: 2 }}>
        <Typography variant="h3" sx={{ fontSize: 20 }}>Invoice details</Typography>
      ...
      <ToolPaper sx={{ mb: 3 }}>
        <Grid container spacing={2}>
          ...
          <Grid size={{ xs: 4 }}>
            <TextField label="Invoice #" fullWidth value={number} onChange={(e) => setNumber(e.target.value)} />
          </Grid>
          <Grid size={{ xs: 4 }}>
            <TextField label="Issue date" type="date" fullWidth value={date} onChange={(e) => setDate(e.target.value)} slotProps={{ inputLabel: {  shrink: true  } }} />
          </Grid>
          <Grid size={{ xs: 4 }}>
            <TextField label="Due date" type="date" fullWidth value={due} onChange={(e) => setDue(e.target.value)} slotProps={{ inputLabel: {  shrink: true  } }} />
          </Grid>
        </Grid>
      </ToolPaper>
      ...
      {/* Printable invoice */}
      <Paper id="invoice-print" sx={{ p: { xs: 3, sm: 5 }, mt: 4, maxWidth: 800, mx: "auto", bgcolor: "#fff", color: "#000" }}>
        <Box sx={{ display: "flex", justifyContent: "space-between", mb: 4 }}>
          <Box>
            <Typography variant="h4" sx={{ fontWeight: 800, color: "#0f172a" }}>INVOICE</Typography>
