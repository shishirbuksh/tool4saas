...
export const healthTools: Tool[] = [
  {
    ...
    category: "health",
    faq: [{ question: "How is BMR calculated?", answer: "Mifflin-St Jeor: Men 10*kg+6.25*cm-5*age+5, Women -161. TDEE=BMR×activity factor." }, { question: "Is this medical advice?", answer: "No, for informational purposes only. Consult a healthcare professional." }, { question: "What example shows maintenance versus deficit?", answer: "Example: 70kg, 175cm, 30-year-old man with moderate activity has about 2600 kcal TDEE; maintenance eats that, deficit subtracts 300-500 kcal, surplus adds 200-300 kcal." }],
