...
export const businessTools: Tool[] = [
  {
    ...
    category: "business",
    faq: [{"question":"Is the invoice generator free to use?","answer":"Yes, it is completely free and runs in your browser. Your data never leaves your device."},{"question":"Can I download or print the invoice as PDF?","answer":"Yes. Use your browser's Print (Ctrl/Cmd+P) and choose 'Save as PDF' — the invoice is formatted for clean printing."},{"question":"How many line items can an invoice hold?","answer":"Add up to 50 line items with qty, rate and tax, e.g. 3 design tasks at $250 each, with auto subtotal, tax and grand total."}],
  ...
  },
  {
    ...
    category: "business",
    faq: [{"question":"How is commission calculated?","answer":"Commission = sales × (rate ÷ 100). Total = sales + commission."},{"question":"Are calculations local?","answer":"Yes. All calculations run in your browser."},{"question":"Can I handle tiered or split commissions?","answer":"This tool does flat-rate math, e.g. $10,000 at 7.5% equals $750; for tiers, run each slab separately and add totals."}],
    howTo: [{"name":"Enter sales amount","text":"Type sales like $10,000 or Rs 5,00,000 for the deal."},{"name":"Enter commission rate","text":"Type rate like 7.5%; e.g. 10% on $2,000 equals $200."},{"name":"View results","text":"See commission e.g. $750 and total $10,750 update instantly."},{"name":"Compare scenarios","text":"Try 5% vs 10%, e.g. $500 vs $1,000 on $10,000, to negotiate splits."}],
  },
  {
  ...
  },
  {
    ...
    category: "business",
    faq: [{"question":"How is total calculated?","answer":"Subtotal = sum(qty×rate), tax = subtotal×rate%, total = subtotal+tax."},{"question":"Is it private?","answer":"Yes, all rows, totals, and notes stay in browser memory; closing the tab clears the draft."},{"question":"Can I add validity dates and payment notes?","answer":"Yes, add quote number, e.g. QUO-2026-014, plus 15-day validity, tax percent and bank terms before printing to PDF."}],
  ...
  },
  {
    ...
    category: "business",
    faq: [{"question":"How is total calculated?","answer":"Subtotal = sum(qty×rate), tax = subtotal×rate%, total = subtotal+tax."},{"question":"Is it private?","answer":"Yes, supplier details and line items stay in local tab memory; nothing is sent to a server."},{"question":"Can I reuse PO numbers across orders?","answer":"Yes, set custom numbers like PO-1042 per supplier locally; drafts stay in tab memory, so save PDFs for records."}],
