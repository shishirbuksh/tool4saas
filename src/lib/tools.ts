...
export const tools: Tool[] = [
  {
    ...
    description:
      "Build clean, professional PDF-ready invoices with your logo, line items, taxes and notes. Free and private — everything stays in your — offline, private, no.",
    icon: "ReceiptLong",
  ...
  },
  {
    ...
    description:
      "Generate downloadable QR codes for URLs, text, email, phone and WiFi. Customize size and download as PNG in one click. — offline, private, no tracking, instant.",
    icon: "QrCode2",
  ...
  },
  {
    ...
    description:
      "Craft a tidy, ATS-friendly resume with sections for experience, education and skills. Preview live and print to PDF. — offline, private, no tracking, instant.",
    icon: "Description",
  ...
  },
  {
    ...
    description:
      "Instantly count words, characters, sentences and paragraphs. Estimate reading time and check keyword density for your — offline, private, no tracking, instant.",
    icon: "TextSnippet",
  ...
  },
  {
    ...
    description:
      "Create secure, random passwords with customizable length and character sets using your browser's crypto engine. Copy and use instantly. — offline, private, no.",
    icon: "Key",
  ...
  },
  {
    ...
    description:
      "Beautify, validate and minify JSON instantly. Catch syntax errors with clear messages — all processing happens in your browser. — offline, private, no.",
    icon: "DataObject",
  ...
  },
  {
    ...
    description:
      "Convert text between uppercase, lowercase, title case, sentence case, camelCase and snake_case in a single click. — offline, private, no tracking, instant.",
    icon: "Subject",
  ...
  },
  {
    ...
    description:
      "Generate Lorem Ipsum placeholder paragraphs, sentences or words for mockups and designs. Copy to clipboard instantly. — offline, private, no tracking, instant.",
    icon: "Notes",
  ...
  },
  {
    ...
    description:
      "Convert between common units of length, weight, temperature, time and data — fast and accurate, right in your browser. — offline, private, no tracking, instant.",
    icon: "Straighten",
  ...
  },
  {
    ...
    description:
      "Calculate your exact age in years, months and days, plus your next birthday and the weekday you were born — all — offline, private, no tracking, instant.",
    icon: "Cake",
  ...
  },
  {
    ...
    description:
      "Convert colors between HEX, RGB and HSL and pick colors with a visual picker. Copy any format you — offline, private, no tracking, instant download, secure.",
    icon: "ColorLens",
  ...
  },
  {
    ...
    description:
      "Encode text to Base64 or decode Base64 back to text, with full Unicode support. Handy for debugging tokens and data — offline, private, no tracking, instant.",
    icon: "Code",
  ...
  },
  {
    ...
    description:
      "Percent-encode or decode URLs and query strings safely. Great for building links and debugging web — offline, private, no tracking, instant download, secure.",
    icon: "Link",
  ...
  },
  {
    ...
    description:
      "Compare two blocks of text and see added and removed words highlighted. Perfect for reviewing changes and edits. — offline, private, no tracking, instant.",
    icon: "Difference",
  ...
  },
  {
    ...
    description:
      "Generate SHA-1, SHA-256, SHA-384 or SHA-512 hashes of your text using the browser's Web Crypto API. Nothing is — offline, private, no tracking, instant.",
    icon: "Fingerprint",
  ...
  },
  {
    ...
    description:
      "Convert titles or a list of topics into clean, SEO-friendly URL slugs. Supports hyphen or underscore separators and bulk input. — offline, private, no.",
    icon: "LocalOffer",
  ...
  },
  {
    ...
    description:
      "Generate secure random integers within a range, in batches, optionally unique. Powered by your browser's crypto engine. — offline, private, no tracking, instan.",
    icon: "Shuffle",
  ...
  },
  {
    ...
    description:
      "Sort lines alphabetically, remove duplicates and blank lines, reverse or shuffle a list. Handy for quick text cleanup. — offline, private, no tracking, instant.",
  ...
  },
  {
    ...
    description:
      "Convert numbers between binary, octal, decimal and hexadecimal (and any base 2–36). Great for developers and students. — offline, private, no tracking, instant.",
    icon: "Transform",
  ...
  },
  {
    ...
    description:
      "Generate RFC-4122 v4 UUIDs using your browser's crypto. Create one or many at once, optionally uppercase, and copy them — offline, private, no tracking, instan.",
    icon: "Tag",
  ...
  },
  {
    ...
    description:
      "Work out a percentage of a number, what percent one number is of another, and increases or decreases — instantly. — offline, private, no tracking, instant.",
    icon: "Percent",
  ...
  },
  {
    ...
    description:
      "Convert Unix epoch timestamps to dates and back, see the current epoch, and inspect both local and UTC — offline, private, no tracking, instant download, secur.",
    icon: "Schedule",
  ...
  },
  {
    ...
    description:
      "Escape or unescape HTML entities (>, <, &, quotes and more) for safe display in markup. Fully — offline, private, no tracking, instant download, secure and.",
    icon: "Html",
  ...
  },
  {
    ...
    description:
      "Test and debug regular expressions against any text. Toggle flags, see every match with its position, and catch invalid patterns — all — offline, private, no.",
    icon: "Code",
  ...
  },
  {
    ...
    description:
      "Decode the header and payload of a JSON Web Token (JWT) to inspect claims. Decoding is done locally and nothing is sent to a server. — offline, private, no.",
    icon: "VpnKey",
  ...
  },
  {
    ...
    description:
      "Convert an array of JSON objects to CSV, or parse CSV back into JSON. Perfect for spreadsheets and APIs — fully in your browser. — offline, private, no.",
    icon: "TableChart",
  ...
  },
  {
    ...
    description:
      "Add or subtract days from a date, or find the number of days between two dates. Handy for planning and deadlines — all client-side. — offline, private, no.",
    icon: "DateRange",
  ...
  },
  {
    ...
    description:
      "Calculate your Body Mass Index from weight and height, in metric or imperial units, and see which category you fall — offline, private, no tracking, instant.",
    icon: "FitnessCenter",
  ...
  },
  {
    ...
    description:
      "Calculate the tip and total for a bill, and split it across any number of people. Quick and private — runs in your — offline, private, no tracking, instant.",
    icon: "Restaurant",
  ...
  },
  {
    ...
    description:
      "Check the contrast ratio between a foreground and background color and see if it passes WCAG AA and AAA for normal and large text. — offline, private, no.",
    icon: "Contrast",
  ...
  },
  {
    ...
    description:
      "Reverse your text by characters, by word order, or line by line. Great for puzzles, quick checks and fun — all in your browser. — offline, private, no.",
    icon: "Replay",
  ...
  },
  {
    ...
    description:
      "Analyze any text for word frequency and keyword density, ignoring common stopwords, to help with SEO and editing. — offline, private, no tracking, instant.",
    icon: "BarChart",
  ...
  },
  {
    ...
    description:
      "Turn any text into spoken audio using your browser's built-in voices. Adjust rate and pitch, then play or stop — offline, private, no tracking, instant.",
    icon: "VolumeUp",
  ...
  },
  {
    ...
    description:
      "Split a URL into protocol, host, path, and query parameters to debug links and APIs. Everything is parsed in your — offline, private, no tracking, instant.",
    icon: "Http",
  ...
  },
  {
    ...
    description:
      "Convert integers into English words — handy for checks, invoices and documents. Works entirely in your browser. — offline, private, no tracking, instant.",
    icon: "Spellcheck",
  ...
  },
  {
    ...
    description:
      "Convert between Roman numerals and standard Arabic numbers (1–3999). Useful for clocks, chapters, and learning. — offline, private, no tracking, instant.",
    icon: "Numbers",
  ...
  },
  {
    ...
    description:
      "Convert an image file into a Base64 data URL, or preview a Base64 image. Perfect for embedding images in CSS or HTML — no upload needed. — offline, private, no.",
    icon: "Image",
  ...
  },
  {
    ...
    description:
      "Build linear or radial CSS gradients with two colors and a live preview. Copy the CSS to drop into your project. — offline, private, no tracking, instant.",
    icon: "Gradient",
  ...
  },
  {
    ...
    description:
      "Extract and de-duplicate email addresses from pasted text or a list. Great for outreach and cleaning contact data — all in your browser. — offline, private, no.",
    icon: "Markunread",
  ...
  },
  {
    ...
    description:
      "Generate secure random strings and keys with selectable character sets and bulk output. Useful for tokens, salts and test data. — offline, private, no.",
    icon: "Abc",
  ...
  },
  {
    ...
    description:
      "Look up the MIME type for a file extension, or find the extension for a MIME type. Handy for headers and uploads. — offline, private, no tracking, instant.",
    icon: "AttachFile",
  ...
  },
  {
    ...
    description:
      "Create a PNG favicon from a letter, emoji or short text with custom colors. Download it instantly — no design tools — offline, private, no tracking, instant.",
    icon: "EmojiEmotions",
  ...
  },
  {
    ...
    description:
      "Generate a color palette (complementary, analogous, triadic and shades) from a single base color. Copy any hex with a — offline, private, no tracking, instant.",
    icon: "Palette",
  ...
  },
  {
    ...
    description:
      "Estimate your monthly loan payment, total paid and total interest from the loan amount, annual rate and term. All in your browser. — offline, private, no.",
    icon: "AccountBalance",
    ...
    howTo: [{"name":"Enter loan details","text":"Add amount, annual rate and term in years."},{"name":"Read results","text":"See monthly payment and totals."},{"name":"Adjust inputs","text":"Change rate or term to compare scenarios."},{"name":"Plan budget","text":"Use totals to plan monthly budget and total cost."}],
  },
  {
    ...
    description:
      "Convert a date and time from one timezone to another using your browser's locale data. Perfect for scheduling across — offline, private, no tracking, instant.",
    icon: "Public",
  ...
  },
  {
    ...
    description:
      "Work out the final price and savings after a percentage discount, with an optional tax step. Quick and private. — offline, private, no tracking, instant.",
    icon: "Sell",
  ...
  },
  {
    ...
    description:
      "Convert JSON into clean, human-readable YAML. Great for config files and Kubernetes manifests — all in your browser. — offline, private, no tracking, instant.",
    icon: "DataObject",
  ...
  },
  {
    ...
    description:
      "Format and indent messy HTML into clean, readable markup. Handy before committing templates or debugging layouts. — offline, private, no tracking, instant.",
    icon: "Code",
  ...
  },
  {
    ...
    description:
      "Validate a card number with the Luhn algorithm and detect the brand. A privacy-safe way to sanity-check input — never enter real cards on unknown sites. — offline, private, no tracking.",
    icon: "CreditCard",
    ...
    howTo: [{"name":"Enter number","text":"Type or paste the card number."},{"name":"Read result","text":"See brand, length and validity."},{"name":"Check formatting","text":"Review spaces and dashes handling."},{"name":"Use securely","text":"Use only for validation, never for real transactions on untrusted sites."}],
  },
  {
    ...
    description:
      "Check a password's strength against common rules (length, case, numbers, symbols). Runs locally so your password never leaves the device. — offline, private, n.",
    icon: "VerifiedUser",
  ...
  },
  {
    ...
    description:
      "Resize an image to exact pixel dimensions or keep the aspect ratio. Download the result as PNG — no upload required. — offline, private, no tracking, instant.",
  ...
  },
  {
    ...
    description:
      "A precise stopwatch with start, pause, lap and reset. Built with requestAnimationFrame for smooth, accurate timing. — offline, private, no tracking, instant.",
    icon: "Timer",
  ...
  },
  {
    ...
    description:
      "Roll any number of dice with any number of sides using a cryptographically secure generator. Perfect for games and — offline, private, no tracking, instant.",
    icon: "Casino",
  ...
  },
  {
    ...
    description:
      "Calculate GST or VAT as an added tax or back out of a tax-inclusive price. Supports both exclusive and inclusive modes. — offline, private, no tracking, instan.",
    icon: "ReceiptLong",
  ...
  },
  {
    ...
    description: "Minify JavaScript, CSS and HTML by stripping comments and whitespace. Paste code, choose language, copy minified output — all local, no — offline, private, no.",
    icon: "Code",
  ...
  },
  {
    ...
    description: "Flip a fair virtual coin with cryptographically secure randomness. Get Heads or Tails instantly and copy the result — no tracking. — offline, private, no.",
    icon: "Toll",
  ...
  },
  {
    ...
    description: "Calculate sales commission and total payout from deal value and rate. Enter amount and percentage to get commission — offline, private, no tracking, instant.",
    icon: "AttachMoney",
  ...
  },
  {
    ...
    description: "Add a solid border to any image. Upload JPG or PNG, set width, height and border color, and download the bordered PNG — processed — offline, private, no.",
    icon: "Image",
  ...
  },
  {
    ...
    description: "Calculate percentage change from old to new value. See increase or decrease as a percent with instant updates. — offline, private, no tracking, instant.",
    icon: "Percent",
  ...
  },
  {
    ...
    description: "Calculate symmetric percentage difference between two values using the absolute average. Great for — offline, private, no tracking, instant download, secure.",
    icon: "Percent",
  ...
  },
  {
    ...
    description: "Generate a secure random passphrase from a curated 120-word list using cryptographically secure shuffling. Choose 1–7 — offline, private, no tracking, instant.",
    icon: "Key",
  ...
  },
  {
    ...
    description: "Calculate business days (Mon–Fri) between two dates. Handles weekends excluding holidays — counts inclusive — all in — offline, private, no tracking, instant.",
    icon: "CalendarToday",
  ...
  },
  {
    ...
    description: "Generate random hex color codes like #6366F1 with one click. Copy HEX, view preview and build palettes instantly. — offline, private, no tracking, instant.",
    icon: "ColorLens",
  ...
  },
  {
    ...
    description: "Detect your screen width, height, device pixel ratio and viewport size instantly. Useful for responsive design — offline, private, no tracking, instant.",
    icon: "PhotoSizeSelectLarge",
  ...
  },
  {
    ...
    description: "Calculate monthly EMI, total interest and amortization schedule for home loans. Adjust principal, rate, tenure and down payment to plan — offline, private, no.",
    icon: "AccountBalance",
  ...
  },
  {
    ...
    description: "See how your money grows with compounding. Enter principal, rate, frequency and years to get maturity amount and interest earned — offline, private, no.",
    icon: "AccountBalance",
  ...
  },
  {
    ...
    description: "Convert between WebP, PNG, JPG, AVIF and HEIC without uploading. Batch-friendly, keeps quality and downloads instantly in your browser. — offline, private, no.",
    icon: "Image",
  ...
  },
  {
    ...
    description: "Write markdown with live preview and export to HTML. Copy, download or print — ideal for READMEs, blogs and docs, all — offline, private, no tracking, instant.",
    icon: "Description",
  ...
  },
  {
    ...
    description: "Format and validate XML with indentation and syntax check. Paste, beautify, minify and copy — handles large files locally without upload. — offline, private, n.",
    icon: "Code",
  ...
  },
  {
    ...
    description: "Strip extra spaces, empty lines, duplicate lines and tabs in bulk. Paste messy text, choose options and get clean, deduped output — offline, private, no.",
    icon: "Subject",
  ...
  },
  {
    ...
    description: "Score reading ease, Flesch-Kincaid grade level and average sentence length. Paste essay to improve clarity and check grade level — offline, private, no.",
    icon: "BarChart",
  ...
  },
  {
    ...
    description: "Parse and explain cron expressions in plain English. Validate 5 fields, see next run times and check schedule without memorizing syntax. — offline, private, no.",
    icon: "Schedule",
  ...
  },
  {
    ...
    description: "Create countdowns to any date with shareable link. Perfect for launches, exams and holidays — see days, hours, minutes and seconds live. — offline, private, no.",
    icon: "Timer",
  ...
  },
  {
    ...
    description: "View, sort, filter and search CSV as a table. Upload, preview and export back to CSV or JSON — handles quoted fields — offline, private, no tracking, instant.",
    icon: "TableChart",
  ...
  },
  {
    ...
    description: "Translate text to Morse code and back instantly. Supports A-Z, 0-9, encode with / for words and decode Morse to text — offline, private, no tracking, instant.",
    icon: "Code",
  ...
  },
  {
    ...
    description: "See current time across world cities side by side. Add any IANA time zone, view offset and copy time for meetings — updates live every — offline, private, no.",
    icon: "Public",
  ...
  },
  {
    ...
    short: "Text ↔ codes",
    description: "Convert text to ASCII codes, hex, binary and octal and back. Paste text, see all encodings and decode any base to text locally. — offline, private, no.",
    icon: "Code",
  ...
  },
  {
    ...
    description: "Optimize SVG by stripping comments, whitespace and empty attributes. Paste SVG, see saved bytes and preview — all locally without upload. — offline, private, n.",
    icon: "Image",
  ...
  },
  {
    ...
    description: "Estimate daily calories, BMR and TDEE from age, sex, weight and activity. Get maintenance, deficit and surplus targets — informational — offline, private, no.",
    icon: "FitnessCenter",
  ...
  },
  {
    ...
    description: "Estimate take-home pay from gross salary, tax rate and deductions. See net annual and per-paycheck amount — informational only. — offline, private, no.",
    icon: "AccountBalance",
  ...
  },
  {
    ...
    short: "Margin & markup",
    description: "Calculate profit, margin and markup from cost and revenue. Enter cost and price to see profit, margin % and markup % instantly. — offline, private, no.",
    icon: "AccountBalance",
  ...
  },
  {
    ...
    description: "Generate XML sitemap from a list of URLs. Paste URLs, set change frequency, priority and lastmod, then copy or download sitemap.xml. — offline, private, no.",
    icon: "Code",
  ...
  },
  {
    ...
    description: "Generate robots.txt with allow, disallow, sitemap and crawl-delay. Choose user-agent, add rules and download ready file locally. — offline, private, no.",
    icon: "Code",
  ...
  },
  {
    ...
    description: "Estimate daily water intake from weight, activity and climate. See liters and glasses per day — informational only, not medical advice. — offline, private, no.",
    icon: "FitnessCenter",
  ...
  },
  {
    ...
    description: "Beautify CSS with proper indentation and line breaks. Paste minified CSS, format for readability and copy — handles large files locally. — offline, private, no.",
    icon: "Code",
  ...
  },
  {
    ...
    description: "Calculate ideal weight via Devine, Robinson and Miller formulas. Enter height and sex to see healthy range and BMI-based target. — offline, private, no.",
    icon: "FitnessCenter",
  ...
  },
  {
    ...
    description: "Split calories into protein, carbs and fat grams. Choose preset or custom ratios to get macro grams and calories per — offline, private, no tracking, instant.",
    icon: "FitnessCenter",
  ...
  },
  {
    ...
    description: "View EXIF metadata from JPEG images. Upload photo to see make, model, date, orientation and GPS — all parsed locally without upload. — offline, private, no.",
    icon: "Image",
  ...
  },
  {
    ...
    description: "Generate barcodes as SVG or PNG for CODE128, EAN13 and UPC. Enter text, set size and download — runs via lazy-loaded JsBarcode. — offline, private, no.",
    icon: "QrCode2",
  ...
  },
  {
    ...
    description: "Convert YAML to JSON instantly. Paste YAML with indentation, lists and scalars and get pretty-printed JSON locally without upload. — offline, private, no.",
    icon: "Code",
  ...
  },
  {
    ...
    description: "Visualize JSON as an expandable tree. Paste JSON, expand or collapse nodes and copy path or value — great for debugging large JSON. — offline, private, no.",
    icon: "DataObject",
  ...
  },
  {
    ...
    description: "Convert file sizes between bytes, KB, MB, GB and TB. Choose binary (1024) or decimal (1000) base and see result — offline, private, no tracking, instant.",
    icon: "Straighten",
  ...
  },
  {
    ...
    description: "Estimate due date, conception date and trimesters from last menstrual period. Enter LMP and cycle length to see due date and weeks — offline, private, no.",
    icon: "Cake",
  ...
  },
  {
    ...
    description: "Pomodoro timer for focus sessions. Set work, break and cycles, start with progress and cycle count — vibrates and notifies on finish. — offline, private, no.",
    icon: "Timer",
  ...
  },
  {
    ...
    description: "Summarize long text extractively via sentence scoring. Paste article, choose ratio and get top sentences in original order — fast and — offline, private, no.",
    icon: "Subject",
  ...
  },
  {
    ...
    description: "Check grammar for double spaces, repeated words, capitalization and common typos. Paste text to see issues with suggestions locally. — offline, private, no.",
    icon: "Spellcheck",
  ...
  },
  {
    ...
    description: "Preview Open Graph and Twitter cards. Enter title, description, image and see Facebook and Twitter card mockups with meta tag output. — offline, private, no.",
    icon: "Public",
  ...
  },
  {
    ...
    description: "Preview Google search snippet with pixel width check. Enter title, description and URL to see snippet and length — offline, private, no tracking, instant.",
    icon: "Search",
  ...
  },
  {
    ...
    short: "Shades & tints",
    description: "Generate shades (mix with black) and tints (mix with white) from any color. Choose steps and copy hex for palette — offline, private, no tracking, instant.",
    icon: "Palette",
  ...
  },
  {
    ...
    description: "Estimate take-home pay after tax from gross salary and deductions. See taxable income, tax, net pay and effective rate — informational — offline, private, no.",
    icon: "AccountBalance",
  ...
  },
  {
    ...
    description: "Calculate GPA from courses, grades and credits. Add courses, choose grades and credits to see GPA, percentage and total credits — offline, private, no.",
    icon: "BarChart",
  ...
  },
  {
    ...
    description: "Check resume against job description for keyword coverage. Paste resume and job to see match %, matched and missing keywords locally. — offline, private, no.",
    icon: "VerifiedUser",
  ...
  },
  {
    ...
    description: "Draw or type your signature on canvas and download as transparent PNG. Choose pen color and width — ideal for PDFs and docs, offline. — offline, private, no.",
    icon: "Image",
  ...
  },
  {
    ...
    description: "Download YouTube thumbnails in HD, SD and maxres. Paste YouTube URL, preview images and copy or download JPG instantly without upload. — offline, private, no.",
    icon: "Image",
  ...
  },
  {
    ...
    description: "Calculate future value and purchasing power with inflation. Enter amount, rate and years to see inflated amount and what it buys today. — offline, private, no.",
    icon: "AccountBalance",
  ...
  },
  {
    ...
    description: "Calculate SIP maturity, invested amount and gains for monthly investments. Enter monthly SIP, annual rate and years to see future value — offline, private, no.",
    icon: "AccountBalance",
  ...
  },
  {
    ...
    description: "Extract 5 dominant colors from any image. Upload photo, see prominent hex swatches with copy — all via canvas locally without upload. — offline, private, no.",
    icon: "Palette",
  ...
  },
  {
    ...
    description: "Convert JSON array to Excel-compatible XLS. Paste JSON, preview table and download.xls that opens in Excel locally. — offline, private, no tracking, instant.",
    icon: "TableChart",
  ...
  },
  {
    ...
    description: "Create professional quotations with line items, tax and notes. Fill, preview and print — data stays locally, same engine as invoice — offline, private, no.",
    icon: "ReceiptLong",
  ...
  },
  {
    ...
    description: "Generate purchase orders with supplier, ship-to, line items and tax. Fill details, preview and print — all data stays locally in your — offline, private, no.",
    icon: "ReceiptLong",
  ...
  },
  {
    ...
    description: "Build tailored cover letters with applicant, job and company details. Choose tone, preview and copy — all offline, no account needed. — offline, private, no.",
    icon: "Description",
  ...
  },
  {
    ...
    description: "Generate fake test data for persons, addresses, companies or lorem. Choose count, generate via secure random and download as CSV locally. — offline, private, n.",
    icon: "Shuffle",
  ...
  },
  {
    ...
    description: "Scan QR codes from images or camera. Upload photo or use camera to decode text, URL or WiFi — runs via lazy-loaded jsQR locally. — offline, private, no.",
    icon: "QrCode2",
  ...
  },
  {
    ...
    description: "Create ZIP files from multiple text files locally. Add files with name and content, generate ZIP via fflate and download — no upload. — offline, private, no.",
    icon: "AttachFile",
  ...
  },
  {
    ...
    description: "Detect AI-written text via heuristic burstiness, variance and repetition. Paste text to see AI likelihood % — heuristic only, not for — offline, private, no.",
    icon: "Spellcheck",
  ...
  },
  {
    ...
    description: "Check text uniqueness via 5-gram duplicate detection and optional source comparison. See uniqueness %, duplicates and matches locally. — offline, private, no.",
    icon: "FindReplace",
  ...
  },
  {
    ...
    description: "Check SSL certificate for any domain. Enter host to see issuer, expiry, grade and days until expiry via SSL Labs API — offline, private, no tracking, instant.",
    icon: "VerifiedUser",
  ...
  },
  {
    ...
    short: "HEX, RGB ↔ CMYK",
    description: "Convert between HEX, RGB and CMYK for print design. Enter any format, see preview and copy — all local without upload. — offline, private, no tracking, instant.",
    icon: "Palette",
  ...
  },
  {
    ...
    title: "Image to PDF",
    short: "Images → PDF",
    description: "Convert multiple images to a single PDF. Add JPG or PNG, choose page size and orientation, then generate and download PDF via jspdf — offline, private, no.",
    icon: "Image",
  ...
  },
  {
    ...
    description: "Combine multiple PDF files into one document. Select PDFs, reorder and download the merged PDF — all offline in your — offline, private, no tracking, instant.",
    icon: "PictureAsPdf",
  ...
  },
  {
    ...
    description: "Compress PDF files to reduce size without leaving your browser. Drop a PDF, choose quality and download the optimized file instantly. — offline, private, no.",
    icon: "PictureAsPdf",
